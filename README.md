...
.
The "walls" of the application can be toggled between solid or let through. Which will either make the particles bounce of the walls or let them fly through. 

Additionally a "gravitron" or attractor can be placed on the canvas which attracts all the particles in the scene.
